...
const products = [
  ...
  },
  {
    ...
    subtitle: 'Best Value - Gold Standard Entry-Level Burr Grinder',
    ...
    <article className={`p-6 bg-white border shadow-lg rounded-lg transition-all duration-300 transform hover:scale-105 ${product.topPick ? 'border-4 border-yellow-500' : ''} ${product.bestValue ? 'border-4 border-green-500' : ''}`}>
      ...
      <div className="flex justify-center mb-4">
        <Image 
          ...
          width={256}
          height={256}
          className="rounded h-64 w-auto object-contain" 
...
export default function BestCoffeeGrinders() {
  ...
  return (
    <>
      <Head>
        <title>5 Best Coffee Grinders – Top Picks for Perfect Coffee Grinding (2025)</title>
      ...
      <main className="bg-white text-gray-900 font-sans">
        ...
        <section className="px-4 md:px-12 py-10 max-w-7xl mx-auto">
          ...
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold mb-4">5 Best Coffee Grinders - 2025</h1>
